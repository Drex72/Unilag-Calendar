...
const Navbar = () => {
  ...
  return (
    <div className="flex min-h-screen">
      <div
        className=" w-[200px] flex flex-col border-r border-grey 
      ...
      >
        ...
        <Link
          to="#"
          className={`flex pr-2 hover:bg-purple hover:text-white space-x-3
                hover:py-2 hover:pl-7 hover:pr-10 hover:rounded transition ease-in-out hover:delay-100
                ${
                  activeLink === 0
                    ? "bg-purple py-2 pl-7 pr-[28px] text-white rounded"
                    : ""
                } `}
        ...
        {isOpen[0] ? (
          <ul className="transition delay-700 duration-300 ease-in-out space-y-2">
            <li className="opacity-[.85] hover:underline">
              <Link to="/sectionI/i">History of the University.</Link>
            </li>
            <li className="opacity-[.85] hover:underline">
              <Link to="/sectionI/ii">
          ...
          <div className="space-y-3 p-3">
            ...
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="visitors" smooth={true} duration={500}>
                <Link to="sectionII/i">Visitor and Principal Officers.</Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="honorable" smooth={true} duration={500}>
                <Link to="/sectionII/i">
            ...
            <div className="opacity-[.85] hover:underline">
              <ScrollLink
                ...
                duration={500}
              >
                <Link to="/sectionII/i">Distinguished Professors.</Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="gold-medallist" smooth={true} duration={500}>
                <Link to="/sectionII/i">Gold Medalist.</Link>
              </ScrollLink>
            </div>
          </div>
        ) : (
        ...
        {isOpen[2] ? (
          <div className="space-y-3 p-3">
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Notes on University Administration.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Vice-Chancellor's Office.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Registry.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Bursary.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Library.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Works & Physical Planning Department.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Dean of Student Affairs Unit.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Academic Planning Unit.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Counselling Unit.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Staff Training and Development Centre.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Security Unit.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Corporate Affairs Directorate.</Link>
            </div>
            <div className="opacity-[.85 hover:underline">
              <Link to="/symbols">Quality Assurance and SERVICOM Unit.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">Office of Endowment.</Link>
            </div>
          </div>
        ) : (
          ""
        ...
        <Link
          ...
          className={`flex pr-2 hover:bg-purple hover:text-white space-x-3
                ...
                ${
                  activeLink === 3
                    ? "bg-purple py-2 pl-7 pr-[40px] text-white rounded"
                    : ""
                } `}
        ...
        <Link
          ...
          className={`flex pr-2 hover:bg-purple hover:text-white space-x-3
                ...
                ${
                  activeLink === 4
                    ? "bg-purple py-2 pr-[26px] pl-7  text-white rounded"
                    : ""
                } `}
        ...
        {isOpen[6] ? (
          <div className="space-y-3 p-3">
            ...
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">
                Faculty of Basic Medical Sciences (CMUL).
              </Link>
            </div>
            <div className="opacity-[.85] hover:underline">
        ...
        {isOpen[7] ? (
          <div className="space-y-3 p-4">
            ...
            <div>
              <Link to="/symbols" className="opacity-[.85] hover:underline">
                Centre for Genomics of Non Communicable Diseases and
                Personalized Health Care (CGNPH).
              </Link>
            </div>
            <div>
              <Link to="/symbols" className="opacity-[.85] hover:underline">
            ...
            <div>
              <Link to="/symbols" className="opacity-[.85] hover:underline">
                West African Regional Research and Training Centre for Low
                Vision and Rehabilitation (WARTCLOR).
              </Link>
            </div>
            <div>
              <Link to="/symbols" className="opacity-[.85] hover:underline">
                World Bank Centre of Excellence for Drug Research, Herbal
                Medicine Development & Regulatory Science (ACEDHARS).
              </Link>
            </div>
            <div>
              <Link to="/symbols" className="opacity-[.85] hover:underline">
        ...
        {isOpen[8] ? (
          <div className="space-y-3 p-3">
            ...
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">
                Unilag Property and Development Unit (PDU).
              </Link>
            </div>
            <div className="opacity-[.85] hover:underline">
        ...
        {isOpen[9] ? (
          <div className="space-y-3 p-3">
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="policies" smooth={true} duration={500}>
                <Link to="sectioX/i">Policies of the University.</Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="policy" smooth={true} duration={500}>
                <Link to="sectionX/ii">
            ...
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="dev" smooth={true} duration={500}>
                <Link to="/sectionX/iii">
                  Policy on Staff Development Pattern.
                </Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="drug" smooth={true} duration={500}>
                <Link to="/sectionX/iv">
            ...
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="boys" smooth={true} duration={500}>
                <Link to="/sectionX/v">
            ...
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="dress" smooth={true} duration={500}>
                <Link to="/sectionX/vi">
            ...
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="polic" smooth={true} duration={500}>
                <Link to="/sectionX/vii">
                  Policy on Staff and Student Relationship/Responsibilities.
                </Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="cell" smooth={true} duration={500}>
                <Link to="/sectionX/viii">Cell Phone Usage policy.</Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="plag" smooth={true} duration={500}>
                <Link to="/sectionX/ix">Plagiarism Policy.</Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="equal" smooth={true} duration={500}>
                <Link to="/sectionX/x">Equal Opportunity Policy.</Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="whistle" smooth={true} duration={500}>
                <Link to="/sectionX/xi">Whistleblowing Policy.</Link>
              </ScrollLink>
            </div>
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="unilag" smooth={true} duration={500}>
                <Link to="/sectionX/xii">
            ...
            <div className="opacity-[.85] hover:underline">
              <ScrollLink to="fire" smooth={true} duration={500}>
                <Link to="/sectionX/xiii">Fire safety Policy.</Link>
              </ScrollLink>
            </div>
          </div>
        ) : (
        ...
        {isOpen[10] ? (
          <div className="space-y-4 p-3">
            ...
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">
                Medical Centre and Health Insurance Scheme.
              </Link>
            </div>
            <div className="opacity-[.85] hover:underline">
            ...
            <div className="oopacity-[.85] hover:underline">
              <Link to="/symbols">
                PInternational School, University of Lagos.
              </Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">
