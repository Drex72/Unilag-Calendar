    ...
    return (
        <div className="flex min-h-screen">
            ...
            >
                ...
                <Link to="/sectionIII/i" className={`flex pr-2 hover:bg-purple hover:text-white space-x-3
                hover:py-2 hover:pl-7 hover:pr-10 hover:rounded transition ease-in-out hover:delay-100
                    ...
                    (<div className="space-y-3 p-3">
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="NotesOnUniversityAdministration" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Notes on University Administration.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="Vice-Chancellor'sOffice" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Vice-Chancellor's Office.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="Registry" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Registry.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="Bursary" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Bursary.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="Library" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Library.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="WorksPhysicalPlanningDepartment" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Works & Physical Planning Department.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="DeanofStudentAffairsUnit" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Dean of Student Affairs Unit.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="AcademicPlanningUnit" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Academic Planning Unit.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="CounsellingUnit" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Counselling Unit.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="StaffTrainingandDevelopmentCentre" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Staff Training and Development Centre.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="SecurityUnit" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Security Unit.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="CorporateAffairsDirectorate" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Corporate Affairs Directorate.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85 hover:underline">
                            <ScrollLink to="QualityAssuranceAndSERVICOMUnit" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Quality Assurance and SERVICOM Unit.</Link>
                            </ScrollLink>
                        </div>
                        <div className="opacity-[.85] hover:underline">
                            <ScrollLink to="OfficeOfEndowment" smooth={true} duration={500}>
                                <Link to="/sectionIII/i">Office of Endowment.</Link>
                            </ScrollLink>
                        </div>
                    </div>) :
                    ""
