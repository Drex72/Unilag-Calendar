...
const Navbar = () => {
  ...
  return (
    <div className="flex w-1/5">
      <div
        className=" w-full flex flex-col border-r border-grey 
      ...
      >
        ...
        {isOpen[1] ? (
          <div className="space-y-3 p-3">
            ...
            <div className="opacity-[.85] hover:underline">
              <Link to="sectionII/ii">Visitor and Principal Officers.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/iii">
                The Honourable Minister of Education.
              </Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/iv">Chancellors.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/v">
            ...
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/vi">Council Members.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/vii">Principal Officers.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/viii">Senate.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/ix">Congregation.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/x">Provost and Deans.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/xi">
                Officers of the College of Medicine.
              </Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/xii">Convocation.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/xiii">Honorary Awardees.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/xiv">Emeritus Professors.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/xv">Distinguished Professors.</Link>
            </div>
            <div className="opacity-[.85] hover:underline">
              <Link to="/sectionII/xvi">Gold Medalist.</Link>
            </div>
          </div>
        ) : (
          ""
        ...
        {isOpen[9] ? (
          <div className="space-y-4 p-3">
            ...
            <div className="opacity-[.85] hover:underline">
              <Link to="/symbols">
                CUNILAG Policy on Sexual harassment, sexual and romantic
