...
import ImageList, { SingleImageItem } from './ImageList';
  ...
  return (
    <MainLayout>
      <Element name="authorities">
        ...
        <div className="[&>span>h4]:text-lg [&>span>h4]:font-bold [&>span]:mb-10 [&>span]:block [&>span]:w-full [&>span>span]:flex [&>span>span]:w-1/2 [&>span>span]:justify-between [&>span>span]:mb-5">
          <span>
            <h4>Visitor</h4>
          </span>
          ...
          <span>
            <h4>Federal Government Appointees</h4>
            <span>
              <p>Dr. Amin Ahmed</p>
              <p>Member</p>
            </span>
            <span>
              <p>Dr. Elizabeth Titi Uvoh-Gardner</p>
              <p>Member</p>
            </span>
            <span>
              <p>Chief Chinedum Adindu</p>
              <p>Member</p>
            </span>
            <span>
              <p>Comrade Mustafa Salihu</p>
              <p>Member</p>
            </span>
          </span>
          <span>
            <h4>Congregation Representatives</h4>
            <span>
          ...
          <span>
            <h4>The Representative of the Ministry of Education</h4>
            <span>
              <p>Barrister Grace Ekanem</p>
              <p>Member</p>
            </span>
          </span>
          <span>
          ...
          <span className="list">
            <h4>Principal Officers</h4>

          </span>
          <span>
            <h4>SENATE MEMBERS</h4>
          </span>
          <span>
            <h4>Professor Ogunsola, Folasade Tolulope</h4>
            <p>Vice-Chancellor</p>
            <p>Department of Med. Micro. & Parasitology</p>
          </span>
          <span>
            <h4>Professor Oboh, Bolanle Olufunmilayo</h4>
            <p>Deputy Vice-Chancellor (Academics & Research)</p>
            <p>Department of Chemistry</p>
          </span>
          <span>
            <h4>Professor Atsenuwa, Ayodele Victoria</h4>
            <p>Deputy Vice-Chancellor (Development Services)</p>
            <p>Department of Public Law</p>
          </span>
          <span>
            <h4>Professor Chukwu, Lucian Obinnaya</h4>
            <p>Deputy Vice-chancellor (Management Services)</p>
            <p>Department of Marine Sciences</p>
          </span>
          <span>
            <h4>Oladejo Azez, Esq</h4>
            <p>Registrar & Secretary to Council</p>
          </span>
          <span>
            <h4>Professor Zaid, Yetunde Abosede</h4>
            <p>University Librarian</p>
          </span>
          <span>
            <h4>Mrs Olakunle E. Makinde</h4>
            <p>Ag. Director, Directorate of Academic Affairs</p>
          </span>
          <span>
            <h4>FACULTY OF ARTS</h4>
          </span>
          <span>
            <h4>Professor Adeboye, Olufunke Asake</h4>
            <p>Dean, Faculty of Arts</p>
          </span>
          <span>
            <h4>Department of History & Strategic Studies</h4>
            <p>Professor Ezenwanebe, Osita Catherine</p>
          </span>
          <span>
            <p>Professor Layiwola, Adepeju Aimenroubiye</p>
            <p>Department of Creative Arts</p>
          </span>
          <span>
            <h4>Professor Oni, Duro</h4>
            <p>Department of Creative Arts</p>
          </span>
          <span>
            <h4>Professor Ademakinwa, Adebisi A</h4>
            <p>Department of Creative Arts</p>
          </span>
          <span>
            <h4>Professor Olusoji, Stephen Olu-Ibukun</h4>
            <p>Department of Creative Arts</p>
          </span>
          <span>
            <h4>Professor Oikelome, Albert Oseghaede</h4>
            <p>Department of Creative Arts</p>
          </span>
          <span>
            <h4>Professor Bamiro, Edmund Olushina</h4>
            <p>Department of English</p>
          </span>
          <span>
            <h4>Professor Okoro, Oko</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor Awonusi, Victor Olusegun</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor Daramola, Mathew Adeyemi</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor Eghagha, Hope Oghenerukevbe</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor King-Aribisala, Karen Ann</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor Maduagwu, Chimdi</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor Nwagbara, Augustine Uzoma</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor Ope-Davies, Babatunde Olusola</h4>
            <p>Department of English</p>
            <p>Sabbatical Leave</p>
          </span>

          <span>
            <h4>Professor Ohwovoriole, Felicia Eruvwetawaren</h4>
            <p>Department of English</p>
          </span>
          <span>
            <h4>Professor Oloko, Patrick</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor Anyokwu, Christopher Chukwudi</h4>
            <p>Department of English</p>
          </span>

          <span>
            <h4>Professor Ariole, Victor Chiagozie</h4>
            <p>Department of European Languages and Integration Studies</p>
          </span>

          <span>
            <h4>Professor Ilupeju, Akanbi Mudashiru</h4>
            <p>Department of European Languages and Integration Studies</p>
          </span>

          <span>
            <h4>Professor Simire, Gregory Osas</h4>
            <p>Department of European Languages and Integration Studies</p>
          </span>

          <span>
            <h4>Professor Adeleke, Ademola</h4>
            <p>Department of History & Strategic Studies</p>
          </span>

          <span>
            <h4>Professor Akinyele, Rufus Taiwo</h4>
            <p>Department of History & Strategic Studies</p>
          </span>

          <span>
            <h4>Professor Akinyeye, Olajompo Abayomi</h4>
            <p>Department of History & Strategic Studies</p>
          </span>

          <span>
            <h4>Professor Aworawo, David</h4>
            <p>Department of History & Strategic Studies</p>
          </span>

          <span>
            <h4>Professor Iwuagwu, Obichere Chilaka</h4>
            <p>Department of History & Strategic Studies</p>
          </span>

          <span>
            <h4>Distinguished Professor Olukoju, Ayodeji Oladimeji</h4>
            <p>Department of History & Strategic Studies</p>
          </span>

          <span>
            <h4>Professor Yusuff, Luqman Ayodele</h4>
            <p>Institute of African and Diaspora Studies</p>
          </span>

          <span>
            <h4>Professor Ajiboye, Oladiipo Jacob</h4>
            <p>Department of Linguistics, African & Asian Studies</p>
          </span>

          <span>
            <h4>Professor Ikwubuzo, Iwu Remingus Obi</h4>
            <p>Department of Linguistics, African & Asian Studies</p>
          </span>

          <span>
            <h4>Professor Orimoogunje, Oladele Caleb</h4>
            <p>Department of Linguistics, African & Asian Studies</p>
          </span>

          <span>
            <h4>Professor Anele, Douglas Ibeawuchi</h4>
            <p>Department of Philosophy</p>
          </span>

          <span>
            <h4>Professor Azenabor, Godwin Ehi</h4>
            <p>Department of Philosophy</p>
          </span>

          <span>
            <h4>Professor Falaiye, Olumuyiwa Adebanjo</h4>
            <p>Department of Philosophy</p>
          </span>

          <span>
            <h4>Professor Ndubuisi, Friday Nwankwo</h4>
            <p>Department of Philosophy</p>
          </span>

          <span>
            <h4>Professor Okoro, Chiedozie Benjamin</h4>
            <p>Department of Philosophy</p>
          </span>

          <span>
            <h4>Distinguished Professor Unah, Jimmy Ijenwa</h4>
            <p>Department of Philosophy</p>
          </span>

          <span>
            <h4>Professor Musa, Ismail Akin</h4>
          ...
          <span>
            <h4>Professor Oke, David Anthonio</h4>
            <p>Provost</p>
            <p>Department of Medicine</p>
          </span>

          <span>
            <h4>Professor Ebuehi, Osaretin Albert</h4>
            <p>Deputy Provost</p>
            <p>Department of Medicine</p>
          </span>

          <span>
            <h4>Faculty of Basic Medical Science</h4>
          </span>

          <span>
            <p>Professor Akinloye, Oluyemi</p>
            <p>Dean, Faculty of Basic Medical Sciences</p>
            <p>Department of Medical Laboratory Science</p>
          </span>

          <span>
            <h4>Professor Abdulkareem, Fatimah Biade</h4>
            <p>Department of Anatomic & Molecular Pathology</p>
          </span>

          <span>
            <h4>Professor Banjo, Adekunbiola Aina Fehintola</h4>
            <p>Department of Anatomic & Molecular Pathology</p>
          </span>

          <span>
            <h4>Professor Daramola, Adetola Olubunmi</h4>
            <p>Department of Anatomic & Molecular Pathology</p>
          </span>

          <span>
            <h4>Professor Anunobi, Charles Chidozie</h4>
            <p>Department of Anatomy</p>
          </span>

          <span>
            <h4>Professor Duru, Francis Ikechukwu</h4>
            <p>Department of Anatomy</p>
          </span>

          <span>
            <h4>Professor Ibeabuchi, Nwachukwu Mike</h4>
            <p>Department of Anatomy</p>
          </span>

          <span>
            <h4>Professor Kusemiju, Taiwo Olabisi</h4>
            <p>Department of Anatomy</p>
          </span>

          <span>
            <h4>Professor Okanlawon, Abayomi Olugbenga</h4>
            <p>Department of Anatomy</p>
          </span>

          <span>
            <h4>Professor Osinubi, Abraham Adewale</h4>
            <p>Department of Anatomy</p>
          </span>

          <span>
            <h4>Professor Adeyemi, Olufunmilayo Olaide</h4>
          ...
          <span>
            <h4>Professor Elemo, O. Babajide</h4>
            <p>Department of Biochemistry</p>
            <p>Sabbatical</p>
          </span>

          <span>
            <h4>Professor Osuntoki, Akiniyi Adediran</h4>
            <p>Department of Biochemistry</p>
          </span>

          <span>
            <h4>Professor Samuel, Titilayo Aderonke</h4>
            <p>Department of Biochemistry</p>
          </span>

          <span>
            <h4>Professor Akande, Idowu Sule</h4>
            <p>Department of Biochemistry</p>
          </span>

          <span>
            <h4>Professor Okunowo, Wahab Oluwanisola</h4>
            <p>Department of Biochemistry</p>
          </span>

          <span>
            <h4>Professor Igwo-Ezikpe, Mariam Nwama</h4>
            <p>Department of Biochemistry</p>
          </span>

          <span>
            <h4>Professor Oyedeji, Kolawole Solomon</h4>
            <p>Department of Medical Laboratory Science</p>
          </span>

          <span>
            <h4>Professor Akinloye, Oluyemi</h4>
            <p>Department of Medical Laboratory Science</p>
          </span>

          <span>
            <h4>Professor Niemogha, Mary Theresa</h4>
            <p>Department of Medical Laboratory Science</p>
          </span>

          <span>
            <h4>Professor Okechresi, O. Obioma</h4>
            <p>Department of Medical Laboratory Science</p>
            <p>Sabbatical Leave</p>
          </span>

          <span>
            <h4>Professor Oduyebo, Oyinlola Omoniyi</h4>
            <p>Department of Med. Micro. & Parasitology</p>
          </span>
          ...
          <span>
            <h4>Professor Omilabu, Sunday Aremu</h4>
            <p>Department of Med. Micro. & Parasitology</p>
          </span>

          <span>
            <h4>Professor Oyibo, Wellington Aghoghovwia</h4>
            <p>Department of Med. Micro. & Parasitology</p>
          </span>

          <span>
            <h4>Professor Agbaje, Esther Oluwatoyin</h4>
            <p>Department of Pharmacology, Therapeutics & Toxicology</p>
          </span>

          <span>
            <h4>Professor Akindele, Abidemi James</h4>
            <p>Department of Pharmacology, Therapeutics & Toxicology</p>
          </span>

          <span>
            <h4>Professor Awodele, Olufunsho</h4>
            <p>Department of Pharmacology, Therapeutics & Toxicology</p>
          </span>

          <span>
            <h4>Professor Oreagba, Ibrahim Adekunle</h4>
            <p>Department of Pharmacology, Therapeutics & Toxicology</p>
          </span>

          <span>
            <h4>Professor Anigbogu, Chikodi Nnanyelu</h4>
            <p>Department of Physiology</p>
          </span>

          <span>
            <h4>Professor Iranloye, Bolanle Olubusola</h4>
            <p>Department of Physiology</p>
          </span>

          <span>
            <h4>Professor Jaja Smith Ishmael</h4>
            <p>Department of Physiology</p>
          </span>
          <span>FACULTY OF CLINICAL SCIENCES.</span>
          <span>
            <h4>Professor Akinsola, Folasade Bolanle</h4>
            <p>Dean, Faculty of Clinical Sciences</p>
            <p>Department of Ophthalmology</p>
          </span>

          <span>
            <h4>Professor Desalu, Ibironke Omidiji</h4>
            <p>Department of Anaesthesia</p>
          </span>

          <span>
            <h4>Professor Azinge Elaine Chinyelu</h4>
            <p>Department of Clinical Pathology</p>
          </span>

          <span>
            <h4>Professor Ekanem, Ekanem Effiong</h4>
            <p>Department of Community Health & Primary Care</p>
          </span>

          <span>
            <h4>Professor Odeyemi, Kofoworola Abimbola</h4>
            <p>Department of Community Health & Primary Care</p>
          </span>

          <span>
            <h4>Professor Onajole, Adebayo Temitayo</h4>
            <p>Department of Community Health & Primary Care</p>
          </span>

          <span>
            <h4>Professor Osibogun, Akinsanya Olayide</h4>
            <p>Department of Community Health & Primary Care</p>
          </span>

          <span>
            <h4>Professor Akanmu, Alani Suleiman</h4>
            <p>Department of Haem. & Blood Trans.</p>
          </span>

          <span>
            <h4>Professor Osunkalu, Vincent Oluseye</h4>
            <p>Department of Haem. & Blood Trans.</p>
          </span>

          <span>
            <h4>Professor Adeyemo, Titilope Adenike</h4>
            <p>Department of Haem. & Blood Trans.</p>
          </span>

          <span>
            <h4>Professor Ajuluchukwu, Janet Ngozi</h4>
            <p>Department of Medicine</p>
          </span>

          <span>
            <h4>Professor Amira, Christiana Oluwatoyin</h4>
            <p>Department of Medicine</p>
          </span>

          <span>
            <h4>Professor Fasanmade, Olufemi Adeola</h4>
            <p>Department of Medicine</p>
          </span>

          <span>
            <h4>Professor Lesi, Olufunmilayo Adenike</h4>
            <p>Department of Medicine</p>
          </span>

          <span>
            <h4>Professor Mbakwem, Chinyere Amam</h4>
            <p>Department of Medicine</p>
          </span>

          <span>
            <h4>Professor Ojini, Francis Ibe</h4>
            <p>Department of Medicine</p>
          </span>
          ...
          <span>
            <h4>Professor Okubadejo, Njideka Ulunma</h4>
            <p>Department of Medicine</p>
          </span>

          <span>
            <h4>Professor Adeyemo, Florence</h4>
            <p>Department of Nursing Sciences</p>
            <p>Sabbatical Leave</p>
          </span>

          <span>
            <h4>Professor Afolabi, Abosede Bukola</h4>
            <p>Department of Obstetrics & Gynaecology</p>
          </span>

          <span>
            <h4>Professor Anorlu, Rose Ihuoma</h4>
            <p>Department of Obstetrics & Gynaecology</p>
          </span>

          <span>
            <h4>Professor Adegbola, Omololu</h4>
            <p>Department of Obstetrics & Gynaecology</p>
          </span>

          <span>
            <h4>Professor Onakoya, Adeola Olukorede</h4>
            <p>Department of Ophthalmology</p>
          </span>
          ...
          <span>
            <h4>Professor Akinsulie, Adebola Olumide</h4>
            <p>Department of Paediatrics</p>
          </span>

          <span>
            <h4>Professor Ekure, Ekanem Nsikak</h4>
            <p>Department of Paediatrics</p>
          </span>

          <span>
            <h4>Professor Ezeaka, Veronica Chinyere</h4>
            <p>Department of Paediatrics</p>
          </span>

          <span>
            <h4>Professor Lesi, Foluso Ebun</h4>
            <p>Department of Paediatrics</p>
          </span>

          <span>
            <h4>Profesor Oduwole, Abiola Olanrewaju</h4>
            <p>Department of Paediatrics</p>
          </span>

          <span>
            <h4>Professor Okoromah, Christy Nene</h4>
            <p>Department of Paediatrics</p>
          </span>

          <span>
            <h4>Professor Temiye, Edamisan Olusoji</h4>
            <p>Department of Paediatrics</p>
          </span>

          <span>
            <h4>Professor Esezobor, Christopher Imokhuede</h4>
            <p>Department of Paediatrics</p>
          </span>

          <span>
            <h4>Professor Akinbo, Sunday Rufus</h4>
            <p>Department of Physiotherapy</p>
          </span>

          <span>
            <h4>Professor Odebiyi, Daniel Oluwafemi</h4>
            <p>Department of Physiotherapy</p>
          </span>

          <span>
            <h4>Professor Olawale, Olajide Ayinla</h4>
            <p>Department of Physiotherapy</p>
          </span>

          <span>
            <h4>Professor Tella, Bosede Abidemi</h4>
            <p>Department of Physiotherapy</p>
          </span>

          <span>
            <h4>Professor Adeyemi, Joseph Dada</h4>
            <p>Department of Psychiatry</p>
          </span>

          <span>
            <h4>Professor Aina, Olatunji Francis</h4>
            <p>Department of Psychiatry</p>
          </span>

          <span>
            <h4>Professor Aweda, Moses Adebayo</h4>
            <p>
          ...
          <span>
            <h4>Professor Soyebi, Kofoworola Oluwatoyin</h4>
            <p>
              Department of Radiation Biology, Radiotherapy and Radiodiagnosis
            </p>
          </span>
          ...
          <span>
            <h4>Professor Irurhe, Nicholas Kayode</h4>
            <p>
              Department of Radiation Biology, Radiotherapy and Radiodiagnosis
            </p>
          </span>
          ...
          <span>
            <h4>Professor Ademuyiwa, Adesoji Oludotun</h4>
            <p>Department of Surgery</p>
          </span>

          <span>
            <h4>Professor Adesanya, Adedoyin Adekunle</h4>
            <p>Department of Surgery</p>
          </span>

          <span>
            <h4>Professor Atoyebi, Oluwole Ayoola</h4>
            <p>Department of Surgery</p>
          </span>

          <span>
            <h4>Professor Bode Christopher Olusanjo</h4>
            <p>Department of Surgery</p>
            <p>Leave of Absence</p>
          </span>

          <span>
            <h4>Professor Nwawolo, Clement Chukwuemeka</h4>
            <p>Department of Surgery</p>
          </span>

          <span>
            <h4>Professor Somefun, Abayomi Oladapo</h4>
            <p>Department of Surgery</p>
          </span>

          <span>
            <h4>Professor Tijani, Kehinde Habeeb</h4>
            <p>Department of Surgery</p>
          </span>

          <span>
            <h4>Professor Ugburo, Andrew Omotayo</h4>
            <p>Department of Surgery</p>
          </span>
          <span>
            <h4>FACULTY OF DENTAL SCIENCES </h4>
          </span>
          <h2>Faculty of Dental Sciences</h2>
          <span>
            <h4>Professor daCosta, Oluranti Olatokunbo</h4>
            <p>Dean, Faculty of Dental Sciences</p>
            <p>Department of Child Dental Health</p>
          </span>

          <span>
            <h4>Professor Oredugba, Folakemi Adenike</h4>
            <p>Department of Child Dental Health</p>
          </span>

          <span>
            <h4>Professor Orenuga, Olubunmi Omolola</h4>
            <p>Department of Child Dental Health</p>
          </span>

          <span>
            <h4>Professor Sanu, Oluwatosin Oluyemi</h4>
            <p>Department of Child Dental Health</p>
          </span>

          <span>
            <h4>Professor Utomi, Ifeoma Linda</h4>
            <p>Department of Child Dental Health</p>
          </span>

          <h3>Department of Oral & Maxillofacial Surgery</h3>
          <span>
            <h4>Professor Gbotolorun, Olalekan Micah</h4>
            <p>Department of Oral & Maxillofacial Surgery</p>
          </span>

          <span>
            <h4>Professor Adeyemo, Wasiu Lanre</h4>
            <p>Department of Oral & Maxillofacial Surgery</p>
          </span>

          <span>
            <h4>Professor Arotiba, Godwin Toyin</h4>
            <p>Department of Oral & Maxillofacial Surgery</p>
          </span>

          <span>
            <h4>Professor Ladeinde, Akinola Oladipo</h4>
            <p>Department of Oral & Maxillofacial Surgery</p>
          </span>

          <span>
            <h4>Professor Ogunlewe, Mobolanle Olugbenga</h4>
            <p>Department of Oral & Maxillofacial Surgery</p>
          </span>

          <span>
            <h4>Professor Effiom, Olajumoke</h4>
            <p>Department of Oral & Maxillofacial Surgery</p>
          </span>

          <span>
            <h4>Professor Ajayi, Oluseyi Folake</h4>
            <p>Department of Oral & Maxillofacial Surgery</p>
          </span>
          <span>
            <h4>Professor Ayanbadejo, Patricia Omowunmi</h4>
            <p>Department of Preventive Dentistry</p>
          </span>
          <span>
            <h4>Professor Sofola, Oyinkansola Olulola</h4>
            <p>Department of Preventive Dentistry</p>
          </span>

          <span>
            <h4>Professor Uti, Omolara Gbonjubola</h4>
            <p>Department of Preventive Dentistry</p>
          </span>

          <span>
            <h4>Professor Umeizudike, Kehinde Adesola</h4>
            <p>Department of Preventive Dentistry</p>
          </span>

          <span>
            <h4>Professor Umesi, Donna Chioma</h4>
            <p>Department of Preventive Dentistry</p>
          </span>

          <h3>Department of Restorative Dentistry</h3>
          <span>
            <h4>Professor Akeredolu, Patricia Adetokunbo</h4>
          ...
          <span>
            <h4>Professor Oladipo, Simeon Adebayo</h4>
            <p>Dean, Faculty of Education</p>
            <p>Department of Educational Management</p>
          </span>

          <h4>Department of Adult Education</h4>
          <span>
            <h4>Professor Egenti, Maureen Ngozi</h4>
            <p>Department of Adult Education</p>
          </span>

          <span>
            <h4>Professor Obashoro-John, Oluwayemisi Ayedun</h4>
            <p>Department of Adult Education</p>
          </span>

          <span>
            <h4>Professor Oladapo, Olubunmi Cecilian</h4>
            <p>Department of Adult Education</p>
          </span>

          <span>
            <h4>Professor Bakare, Tewogbai Veronica</h4>
            <p>Department of Adult Education</p>
          </span>

          <h4>Department of Arts & Social Sciences Education</h4>
          <span>
            <h4>Professor Igwe, Rosita Okekenwa</h4>
            <p>Department of Arts & Social Sciences Education</p>
          </span>

          <span>
            <h4>Professor Ikonta, Nonye Rose</h4>
            <p>Department of Arts & Social Sciences Education</p>
          </span>

          <span>
            <h4>Professor Maduekwe, Anthonia Ngozika</h4>
            <p>Department of Arts & Social Sciences Education</p>
          </span>

          <h4>Department of Educational Foundation</h4>
          <span>
            <h4>Professor Ubangha, Monday Bassey</h4>
            <p>Department of Educational Foundation</p>
          </span>

          <span>
            <h4>Professor Nwadinigwe, Ikechukwu Peter</h4>
            <p>Department of Educational Foundations</p>
          </span>

          <span>
            <h4>Professor Olusakin, Ayoka Mopelola</h4>
            <p>Department of Educational Foundations</p>
          </span>

          <span>
            <h4>Professor Osarenren, Ngozi Azuka</h4>
            <p>Department of Educational Foundations</p>
          </span>

          <h4>Department of Human Kinetics & Health Education</h4>
          <span>
            <h4>Professor Awopetu, Adeyemi Rapheal</h4>
            <p>Department of Human Kinetics & Health Education</p>
          </span>

          <span>
            <h4>Professor Haastrup, Edward Aderele</h4>
            <p>Department of Human Kinetics & Health Education</p>
          </span>

          <span>
            <h4>Professor Otinwa, Grace Olapeju</h4>
            <p>Department of Human Kinetics & Health Education</p>
          </span>

          <span>
            <h4>Professor Onwuama, Mercy Adakuchi</h4>
            <p>Department of Human Kinetics & Health Education</p>
          </span>

          <span>
            <h4>Professor Adeyeye, Festus Mayowa</h4>
            <p>Department of Human Kinetics & Health Education</p>
          </span>

          <h4>Department of Science & Technology Education</h4>
          <span>
            <h4>Professor Adyemo, Sunday Adeniyi</h4>
            <p>Department of Science & Technology Education</p>
          </span>

          <span>
            <h4>Professor Esiobu, Gladys Obianuju</h4>
            <p>Department of Science & Technology Education</p>
          </span>

          <span>
            <h4>Professor Oke, Catherine Oyenike</h4>
            <p>Department of Science & Technology Education</p>
          </span>

          <span>
            <h4>Professor Udeani, Uche Nkiruka</h4>
            <p>Department of Science & Technology Education</p>
          </span>
        </div>
      </Element>
      <Element name="visitors">
        <TextHeading content='Visitors' />
        <ImageList>
          <SingleImageItem content={(
            <div>
              <h4>The President, Commander-in-Chief of the Armed Forces, </h4>
              <p>His Excellency Muhammadu Buhari, GCFR</p>
          ...
          <SingleImageItem content={(
            <div>
              <h4>The Honourable Minister of Education</h4>
              <p>Mallam Adamu Adamu</p>
              <p>Federal Republic of Nigeria</p>
            </div>
          )} />
        </ImageList>
      ...
      <Element name="chancellors">
        ...
        <ImageList>
          <SingleImageItem content={(
            <div>
              <h4>His Royal Eminence</h4>
              <p>Alhaji (Dr.) Abubakar Ibn Umar Garbai El-Kanemi, CFR</p>
              <p>Federal Republic of Nigeria</p>
            </div>
          )} />
        </ImageList>
      ...
      <Element name="senate">
        ...
        <ImageList>
          <SingleImageItem content={(
            <div>
              <h4>Vice-Chancellor</h4>
              <p>Professor Ogunsola, Folasade Tolulope</p>
              <p>Department of Med. Micro. & Parasitology</p>
            </div>
          )} />
          <SingleImageItem content={(
            <div>
              <h4>Deputy Vice-Chancellor (Academics & Research)</h4>
              <p>Professor Oboh, Bolanle Olufunmilayo</p>
              <p>Department of Chemistry</p>
            </div>
          )} />
          <SingleImageItem content={(
            <div>
              <h4>Deputy Vice-Chancellor (Development Services)</h4>
              <p>Professor Atsenuwa, Ayodele Victoria</p>
              <p>Department of Public Law</p>
          ...
          <SingleImageItem content={(
            <div>
              <h4>Deputy Vice-chancellor (Management Services)</h4>
              <p>Professor Chukwu, Lucian Obinnaya</p>
              <p>Department of Marine Sciences</p>
          ...
          <SingleImageItem content={(
            <div>
              <h4>Registrar & Secretary to Council</h4>
              <p>Oladejo Azez, Esq</p>
            </div>
          )} />
        </ImageList>
